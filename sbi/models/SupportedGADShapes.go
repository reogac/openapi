...
const (
	...
	SUPPORTEDGADSHAPES_LOCAL_2D_POINT_UNCERTAINTY_ELLIPSE   SupportedGADShapes = "LOCAL_2D_POINT_UNCERTAINTY_ELLIPSE"
	SUPPORTEDGADSHAPES_LOCAL_3D_POINT_UNCERTAINTY_ELLIPSOID SupportedGADShapes = "LOCAL_3D_POINT_UNCERTAINTY_ELLIPSOID"
)
