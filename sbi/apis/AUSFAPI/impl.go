...
func HandleEapAuthMethod(authCtxId string,body *models.EapSession)(rsp *models.EapAuthMethodResponse,prob *models.ProblemDetails){
	return
}

func HandleRgAuthenticationsPost(body *models.RgAuthenticationInfo)(rsp *models.RgAuthCtx,prob *models.ProblemDetails){
	return
}

func HandleProseAuthenticationsPost(body *models.ProSeAuthenticationInfo)(rsp *models.ProSeAuthenticationCtx,prob *models.ProblemDetails){
	return
}
