...
func HandleGetRgAuthData(params *NudmUEAU.GetRgAuthDataParams)(rsp *models.RgAuthCtx,prob *models.ProblemDetails){
	return
}

func HandleConfirmAuth(supi string,body *models.AuthEvent)(rsp *models.AuthEvent,prob *models.ProblemDetails){
	return
}
