...
func HandleCancelRelocateUEContext(ueContextId string,body *models.CancelRelocateUEContextRequest)(prob *models.ProblemDetails){
	return
}
...
func HandleCreateUEContext(ueContextId string,body *models.CreateUEContextRequest)(rsp *models.CreateUEContextResponse,ersp *UeContextCreateError,prob *models.ProblemDetails){
	return
}
...
func HandleReleaseUEContext(ueContextId string,body *models.UEContextRelease)(prob *models.ProblemDetails){
	return
}
...
func HandleN1N2MessageSubscribe(ueContextId string,body *models.UeN1N2InfoSubscriptionCreateData)(rsp *models.UeN1N2InfoSubscriptionCreatedData,prob *models.ProblemDetails){
	return
}
*/
